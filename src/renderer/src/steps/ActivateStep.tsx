...
// ─── Step: Pending Topup (removed model_select step — default baseUrl used directly)
  ...
  const handleVerify = useCallback(
    async (code: string): Promise<void> => {
      ...
      try {
        ...
        // If account is active and has balance, save directly with default baseUrl and go to next
