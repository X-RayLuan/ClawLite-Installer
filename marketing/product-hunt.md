...
- **Name**: ClawLite
- **Tagline**: Install your AI agent with one click
- **Website**: https://clawlite.ai
- **GitHub**: https://github.com/ClawLite/ClawLite-Installer

## Description (Short)

ClawLite is a free, open-source desktop app that installs your AI agent in three steps: download, run, and enter your API key. No terminal commands needed. Supports macOS and Windows.

## Description (Full)

Setting up an AI agent shouldn't require a CS degree. Running a powerful AI agent on Telegram involves Node.js, npm, config files, and gateway processes.
...
✅ **Installs everything automatically** — one click handles Node.js, WSL, and agent setup
...
I'm the maker of ClawLite. I built this because I kept seeing people struggle with the AI agent installation process — especially on Windows, where you need WSL set up properly.
...
2. Environment check — auto-detecting Node.js, WSL, agent status
